...
func main() {
	...
	penilaianController := controller.NewPenilaianController(penilaianRepo, cloRepo, lembarAssessmentRepo, dosenRepo, ploRepo, perancanganObeRepo, plottingDosenRepo, mataKuliahRepo, kelasRepo)
	...
	apiRouter := r.Group("/api")
	{
		...
		penilaianRouter := apiRouter.Group("/penilaian")
		{
			...
			penilaianRouter.GET("/data/matakuliah/tahun/:tahunId", authMiddleware.RequireAdminAuth, penilaianController.GetDataPenilaianMataKuliahByTahun)
			penilaianRouter.GET("/data/matakuliah/:mkId", authMiddleware.RequireAdminAuth, penilaianController.GetDataPenilaianMataKuliahByMk)
